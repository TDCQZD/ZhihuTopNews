...
//无扫描界面人脸登录
public class GetFaceFeatures extends Aty_FaceFeatures {
    ...
    private void getIntentData(String facedata) {
        ...
        try {
            ...
            long smile = obj.getJSONObject("smiling").getLong("score");
            map = new HashMap<String, Object>();
            map.put("key", "微笑值");
            map.put("value", smile);
            list.add(map);
            ...
            long mustache = obj.getJSONObject("mustache").getLong("score");
            map = new HashMap<String, Object>();
            map.put("key", "胡须密度");
